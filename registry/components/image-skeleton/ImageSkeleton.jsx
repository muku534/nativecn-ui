// ImageSkeleton.jsx — Premium grid animation skeleton
        ...
        >
          ...
          <Rect x={0} y={0} width={width} height={height}>
            <RadialGradient
              c={center2}
              r={radius * 0.8}
              colors={[`${accentColor}B3`, `${accentColor}00`]}
            />
          </Rect>
        </Mask>
      </Canvas>
...
export function ImageSkeletonSquare({ size = 200, ...props }) {
  return <ImageSkeleton width={size} height={size} borderRadius={16} {...props} />;
}

export function ImageSkeletonWide({ width = 340, height = 200, ...props }) {
  return <ImageSkeleton width={width} height={height} borderRadius={12} {...props} />;
}

export function ImageSkeletonLight({ width = 300, height = 300, ...props }) {
  return (
    <ImageSkeleton
      width={width}
      height={height}
